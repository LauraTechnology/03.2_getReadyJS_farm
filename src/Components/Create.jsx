...
function Create({create}) {
    ...
    return (
        <div className="cow_farm__form">
            ...
            <div className="cow_farm_form_input">
                <span>Total Milk</span><input type="text" value={inputs.total_milk} onChange={(e) => formControl(e, 'total_milk')} />
            </div>
            <div className="cow_farm_form_input">
                <span>Last Milking Time</span><input type="date" value={inputs.last_milking_time} onChange={(e) => formControl(e, 'last_milking_time')} />
            </div>
            <div className="cow_farm_form_input">
